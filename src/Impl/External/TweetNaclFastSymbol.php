...
class TweetNaclFastSymbol
{
    ...
    public static $crypto_sign_BYTES = 64;
    public static $crypto_sign_PUBLICKEYBYTES = 32;
    public static $crypto_sign_SECRETKEYBYTES = 64;
    public static $crypto_sign_SEEDBYTES = 32;
    ...
    public static function unpackneg(&$r, $p)
    {
        ...
        self::S($chk, $r[0]);
        self::M($chk, $chk, $den);
        if (self::neq25519($chk, $num)) {
            self::M($r[0], $r[0], self::$I);
        }
        ...
        if (self::par25519($r[0]) === ($p[31] >> 7)) {
            self::Z($r[0], self::$gf0, $r[0]);
        }
