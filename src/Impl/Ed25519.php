...
class Ed25519
{
    public static function isCanonicalS($encodedS)
    {
    ...
    public static function sign(string $message, $keyPair, string $hashMode)
    {
        TweetNaclFastSymbol::init();
        return TweetNaclFastSymbol::nacl_sign_detached($message, $keyPair['secretKey'], $hashMode);
    }

    public static function verify($message, $signature, $publicKey, $hashMode)
    {
        TweetNaclFastSymbol::init();
