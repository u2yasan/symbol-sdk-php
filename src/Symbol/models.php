...
class NetworkType
{
    public const MAINNET = 104;

    public const TESTNET = 152;
...
class BlockType
{
    public const NEMESIS = 32835;

    public const NORMAL = 33091;

    public const IMPORTANCE = 33347;
...
{
    public const BLOCK_VERSION = 1;

    public const BLOCK_TYPE = BlockType::NEMESIS;
...
class NormalBlockV1 extends Block
{
    ...
    public const BLOCK_TYPE = BlockType::NORMAL;
...
class ImportanceBlockV1 extends Block
{
    ...
    public const BLOCK_TYPE = BlockType::IMPORTANCE;
...
class ReceiptType
{
    public const MOSAIC_RENTAL_FEE = 4685;

    public const NAMESPACE_RENTAL_FEE = 4942;

    public const HARVEST_FEE = 8515;

    public const LOCK_HASH_COMPLETED = 8776;

    public const LOCK_HASH_EXPIRED = 9032;

    public const LOCK_SECRET_COMPLETED = 8786;

    public const LOCK_SECRET_EXPIRED = 9042;

    public const LOCK_HASH_CREATED = 12616;

    public const LOCK_SECRET_CREATED = 12626;

    public const MOSAIC_EXPIRED = 16717;

    public const NAMESPACE_EXPIRED = 16718;

    public const NAMESPACE_DELETED = 16974;

    public const INFLATION = 20803;

    public const TRANSACTION_GROUP = 57667;

    public const ADDRESS_ALIAS_RESOLUTION = 61763;

    public const MOSAIC_ALIAS_RESOLUTION = 62019;
...
{
    public const RECEIPT_TYPE = ReceiptType::HARVEST_FEE;
...
{
    public const RECEIPT_TYPE = ReceiptType::INFLATION;
...
{
    public const RECEIPT_TYPE = ReceiptType::LOCK_HASH_CREATED;
...
{
    public const RECEIPT_TYPE = ReceiptType::LOCK_HASH_COMPLETED;
...
{
    public const RECEIPT_TYPE = ReceiptType::LOCK_HASH_EXPIRED;
...
{
    public const RECEIPT_TYPE = ReceiptType::LOCK_SECRET_CREATED;
...
{
    public const RECEIPT_TYPE = ReceiptType::LOCK_SECRET_COMPLETED;
...
{
    public const RECEIPT_TYPE = ReceiptType::LOCK_SECRET_EXPIRED;
...
{
    public const RECEIPT_TYPE = ReceiptType::MOSAIC_EXPIRED;
...
{
    public const RECEIPT_TYPE = ReceiptType::MOSAIC_RENTAL_FEE;
...
{
    public const RECEIPT_TYPE = ReceiptType::NAMESPACE_EXPIRED;
...
{
    public const RECEIPT_TYPE = ReceiptType::NAMESPACE_DELETED;
...
{
    public const RECEIPT_TYPE = ReceiptType::NAMESPACE_RENTAL_FEE;
...
class NodeKeyLinkTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::NODE_KEY_LINK;
...
class AggregateCompleteTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::AGGREGATE_COMPLETE;
...
{
    public const TRANSACTION_VERSION = 2;
...
class AggregateBondedTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::AGGREGATE_BONDED;
...
class VotingKeyLinkTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::VOTING_KEY_LINK;
...
class VrfKeyLinkTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::VRF_KEY_LINK;
...
class HashLockTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::HASH_LOCK;
...
{
    public const SHA3_256 = 0;

    public const HASH_160 = 1;

    public const HASH_256 = 2;
...
class SecretLockTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::SECRET_LOCK;
...
class SecretProofTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::SECRET_PROOF;
...
class AccountMetadataTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::ACCOUNT_METADATA;
...
class MosaicMetadataTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_METADATA;
...
class NamespaceMetadataTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::NAMESPACE_METADATA;
...
class MosaicFlags
{
    ...
    public const SUPPLY_MUTABLE = 1;

    public const TRANSFERABLE = 2;

    public const RESTRICTABLE = 4;

    public const REVOKABLE = 8;
...
class MosaicDefinitionTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_DEFINITION;
...
class MosaicSupplyChangeTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_SUPPLY_CHANGE;
...
class MosaicSupplyRevocationTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_SUPPLY_REVOCATION;
...
class MultisigAccountModificationTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MULTISIG_ACCOUNT_MODIFICATION;
...
class AddressAliasTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::ADDRESS_ALIAS;
...
class MosaicAliasTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_ALIAS;
...
class NamespaceRegistrationTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::NAMESPACE_REGISTRATION;
...
class AccountRestrictionFlags
{
    ...
    public const MOSAIC_ID = 2;

    public const TRANSACTION_TYPE = 4;

    public const OUTGOING = 16384;

    public const BLOCK = 32768;
...
class AccountAddressRestrictionTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::ACCOUNT_ADDRESS_RESTRICTION;
...
class AccountMosaicRestrictionTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::ACCOUNT_MOSAIC_RESTRICTION;
...
class AccountOperationRestrictionTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::ACCOUNT_OPERATION_RESTRICTION;
...
class MosaicAddressRestrictionTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_ADDRESS_RESTRICTION;
...
class MosaicGlobalRestrictionTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::MOSAIC_GLOBAL_RESTRICTION;
...
class TransferTransactionV1 extends Transaction
{
    ...
    public const TRANSACTION_TYPE = TransactionType::TRANSFER;
