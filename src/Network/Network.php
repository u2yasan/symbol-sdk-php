...
class Network
{
    ...
    public const BASE32_RFC4648_ALPHABET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567';
    ...
    {
        if ($publicKey instanceof PublicKey || $publicKey instanceof Models\PublicKey) {
            $publicKey = $publicKey->binaryData;
        }
